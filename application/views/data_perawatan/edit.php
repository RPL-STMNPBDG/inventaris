    ...
    <div class="col">
      ...
      <div class="card">
        ...
        <div class="form-group">
            ...
            <input type="text" name="kode_barang" class="form-control" placeholder="kapasitas ruangan" value="<?php echo $data_perawatan->kode_barang ?>" readonly/>
          </div>

          <div class="form-group">
            <label>Tanggal Perawatan</label>
            <input type="date" name="tanggal_perawatan" class="form-control" placeholder="kapasitas ruangan" />
          </div>

          <div class="form-group">
            <label>Keterangan</label>
            <input type="text" name="keterangan" class="form-control" placeholder="Ketrerangan" />
          </div>
