...
<!-- 
  ...
  <?php if (hasPermissions('perawatan_list')) : ?>
    <li class="nav-item">
      <a href="<?php echo url('dataperawatan') ?>" class="nav-link <?php echo ($page->menu == 'dataperawatan') ? 'active' : '' ?>">
        <i class="nav-icon fas fa-university"></i>
        <p>
          <?php echo lang('data_perawatan') ?>
        </p>
      </a>
    </li>
  <?php endif ?>
