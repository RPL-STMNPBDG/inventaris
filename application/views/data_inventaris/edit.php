      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="tahun_peredaran" minlength="6" id="formClient-Password" required placeholder="2019-01-20"  value="<?php echo $data_inventaris->tahun_peredaran ?>">
          </div>

          <div class="form-group">
            <label for="formClient-Password">Jumlah</label>
            <input type="text" class="form-control" name="ukuran" id="formClient-Password" required placeholder="20"  value="<?php echo $data_inventaris->ukuran ?>">
          </div>

          <div class="form-group">
            <label for="formClient-Status">Satuan</label>
            <select name="satuan" id="formClient-Status" class="form-control"  value="<?php echo $data_inventaris->satuan ?>">
            
              <option value="<?php echo $data_inventaris->satuan ?>" selected disabled><?php echo $data_inventaris->satuan ?></option>
    ...
    <div class="col-sm-6">
      ...
      <div class="card">
        ...
        <div class="form-group">
            ...
            <select name="kondisi" id="formClient-Status" class="form-control"  value="<?php echo $data_inventaris->kondisi ?>">
