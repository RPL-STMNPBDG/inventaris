...
class Data_pinjaman_model extends MY_Model {
	...
	{
        $this->db->select('alat_sedang_dipakais.id, alat_sedang_dipakais.status, alat_sedang_dipakais.kode_barang, alat_sedang_dipakais.tanggal_terpakai,alat_sedang_dipakais.kode_ruangan, fasilitas.nama_fasilitas, fasilitas.jenis_fasilitas, users.name, users.email');    
	...
	{
        $this->db->select('alat_sedang_dipakais.id, alat_sedang_dipakais.kode_barang, alat_sedang_dipakais.tanggal_terpakai,alat_sedang_dipakais.kode_ruangan, fasilitas.nama_fasilitas, fasilitas.jenis_fasilitas, users.name, users.email, data_inventaris.tahun_peredaran    ');    
        $this->db->from('alat_sedang_dipakais');
        $this->db->join('fasilitas', 'alat_sedang_dipakais.id_fasilitas = fasilitas.id');
        $this->db->join('users', 'alat_sedang_dipakais.id_pengguna = users.id');
